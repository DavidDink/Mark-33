...
# Fit the model
model.fit(Input, temp_Output, epochs=150, batch_size=10, verbose=2)
# evaluate the model
scores = model.evaluate(Input , temp_Output)

print("\n%s: %.2f%%" % (model.metrics_names[1], scores[1]*100))# round predictions% (model.metrics_names[1], scores[1]*100))
